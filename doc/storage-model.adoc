...
[NOTE]
====
This document contains historical design notes about Datomic's storage internals.
For current documentation, see <<meta.adoc#,Metamodel Reference>> and <<architecture.adoc#,System Architecture>>.
====
