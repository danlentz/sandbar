# Historical jobs API inventory

> **Historical — superseded.** Use the [REST reference](../api/http-rest.md), [workflow substrate](../concepts/workflow-substrate.md), and [temporal substrate](../concepts/temporal-substrate.md) for current contracts. This early endpoint inventory is retained for comparison; its routes and counts have not been revalidated for 0.2.0.
